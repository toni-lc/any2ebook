...
## Development
Install or refresh the project dependencies:
```
make update-deps
```
...
2. Any file containing a list of links starting with `http://` or `https://` (**without quotes**), each link in a new line. Example:
```text 
# links.txt
http://LINK_TO_ARTICLE_1
http://LINK_TO_ARTICLE_2
...
http://LINK_TO_ARTICLE_N
```
Run: 
```
